...
def main():
    ...
    f1.savefig("/home/claude/fig1_dll_chains.png", dpi=150, bbox_inches='tight',
               facecolor=C_BG)
    print("  ✓ fig1_dll_chains.png")

    f2 = fig2_tag_map(app, notes_chrono)
    f2.savefig("/home/claude/fig2_tag_map.png", dpi=150, bbox_inches='tight',
               facecolor=C_BG)
    print("  ✓ fig2_tag_map.png")

    f3 = fig3_circular_buffer(app)
    f3.savefig("/home/claude/fig3_circular_buffer.png", dpi=150, bbox_inches='tight',
               facecolor=C_BG)
    print("  ✓ fig3_circular_buffer.png")

    f4 = fig4_overview(notes_chrono, app)
    f4.savefig("/home/claude/fig4_overview.png", dpi=150, bbox_inches='tight',
               facecolor=C_BG)
    print("  ✓ fig4_overview.png")
